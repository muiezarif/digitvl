...
const BuyCoins = () => {
    ...
    const createPayment = async (userSession) => {
        ...
        formData.append("price","price_1JAXgAI4e8u2GP8q67oEupda")
                        ...
                        <div>
                            <div
                                ...
                                <div className="col-md-6 col-sm-12 col-xs-12 mt-2 my-auto">
                                    <div className="d-flex flex-column">
                                        <div className="d-flex flex-row custom-notifications-item-artist-track">
                                            <div> Get <b className="text-color-accent">100</b> DIGITVL coins for 5$
                                            </div>
                                        </div>
                                ...
                                <div className="col-md-3 col-sm-6 my-auto">
                                    <div className="text-center mt-2">
                                        <div className="btn btn-outline-primary">Buy</div>
                                    </div>
                                </div>
                            ...
                            <div
                                ...
                                <div className="col-md-6 col-sm-12 col-xs-12 mt-2 my-auto">
                                    <div className="d-flex flex-column">
                                        <div className="d-flex flex-row custom-notifications-item-artist-track">
                                            <div>Get <b className="text-color-accent">200</b>  DIGITVL coins for 10$
                                            </div>
                                        </div>
