...
let userSession
class Remastering extends Component {
    state = {
        songTitle: "",
        genre: "",
        description: "",
                ...
                <div className="row custom-row-margin px-3 mt-5">
                    <div className="col-lg-10 col-xl-9 card flex-row mx-auto px-0 custom-bg-dark">
                        <div className="card-body">
                            <h4 className="title text-center mt-4 text-white"><b>Remaster Music</b></h4>
                            ...
                            <form className="row form-box px-3" onSubmit={onSubmit}>
                                ...
                                {/*    </button>*/}
                                {/*</div>*/}
                                <div className="com-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <div className="mb-3">
                                        <button type="submit" disabled={this.state.disableUpload} className="btn btn-block text-uppercase bg-accent">Submit
                                        </button>
                                    </div>
                                </div>
                            </form>
